...
The count component of the hurdle model performed very poorly (RMSE = 150.6, MAE = 43.0, pseudo-R² = 0.02), indicating that the model explained virtually none of the variation in non-zero fish counts.
...
| ------------------------ | ------------------------------------ | ---------: |
| True Negatives (TN)  | correctly predicted absence          |       8360 |
