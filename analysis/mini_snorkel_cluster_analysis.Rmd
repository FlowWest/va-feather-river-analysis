---
title: "Feather River - habitat data exploration"
...
- Absence/presence: May want to consider randomly selecting from the "unoccupied" observations to simulate paired random selection (?)
...
- consider the results with count - maybe this makes sense because the count is so skewed.
- try with a density variable
- try removing the high count variables
